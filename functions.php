...
function twentysixteen_scripts() {
	...
	// smartlun load bootstrap js
	wp_enqueue_script( 'script', get_template_directory_uri() . '/js/bootstrap.min.js', array (), 3.3, true);
...
// twentysixteen_scripts theme end
